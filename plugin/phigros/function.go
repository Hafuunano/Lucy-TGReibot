...
var (
	...
	font                     = transform.ReturnLucyMainDataIndex("phi") + "rec/font.ttf"
	background               = transform.ReturnLucyMainDataIndex("phi") + "rec/illustrationLowRes/" // .png
	backgroundRender         = transform.ReturnLucyMainDataIndex("phi") + "rec/background.png"
	rank                     = transform.ReturnLucyMainDataIndex("phi") + "rec/rank/"
	ChanllengeMode           = transform.ReturnLucyMainDataIndex("phi") + "rec/challengemode/"
	icon                     = transform.ReturnLucyMainDataIndex("phi") + "rec/icon.png"
	a                float64 = 75
)
